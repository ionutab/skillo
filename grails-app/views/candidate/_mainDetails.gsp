...
<div class="box-header">
    <g:if test="${!editable}">
        <div class="box-tools pull-right">
            <g:link controller="candidate" action="edit" id="${candidateInstance?.id}" class="btn btn-sm bg-yellow"><i
                    class="fa fa-pencil append-icon"></i>Edit</g:link>
        </div>
    </g:if>
</div>
...
<div class="col-md-6">
    ...
    <div class="form-group ${hasErrors(bean: candidateInstance, field: 'birthDate', 'has-error')}">
        ...
        <div class="col-sm-9">
            <div class="input-group">
                ...
                <g:field type="textField" name="candidate.birthDate" id="candidateBirthDate"
                         class="form-control datepicker" value="${formatDate(date: candidateInstance?.birthDate)}"
                         default="none" disabled="${!editable}"/>
                <g:javascript>
    ...
    <div class="form-group ${hasErrors(bean: candidateInstance, field: 'email', 'has-error')}">
        ...
        <div class="col-md-9">
            <g:textField name="candidate.email" class="form-control" value="${candidateInstance?.email}"
                         disabled="${!editable}"/>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <g:if test="${editable}">
                <g:radioGroup values="[true, false]" labels="['yes', 'no']" name="candidate.sponsored"
                              value="${candidateInstance?.sponsored}">
...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9 " aria-checked="true" aria-disabled="true">
            ...
            <g:if test="${editable}">
                <g:radioGroup values="[true, false]" labels="['yes', 'no']" name="candidate.driver"
                              value="${candidateInstance?.driver}">
                    <label class="control-label">
                        ${it.radio}&nbsp;${it.label}
                    </label>
                    &nbsp;
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <g:if test="${editable}">
                <g:radioGroup values="[true, false]" labels="['yes', 'no']" name="candidate.carOwner"
                              value="${candidateInstance?.carOwner}">
                    <label class="control-label">
                        ${it.radio}&nbsp;${it.label}
                    </label>
                    &nbsp;
