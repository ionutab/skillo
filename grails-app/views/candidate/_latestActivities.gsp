                    ...
                    <g:each in="${candidateActivities}" status="i" var="activity">
                        ...
                        <!-- timeline icon -->
                            ...
                            <div class="timeline-item">
                                ...
                                <g:if test="${activity.type == ActivityType.CREATE}">
                                    <h3 class="timeline-header">${activity.candidate.getFullName()} have been added</h3>
                                </g:if>
                                <g:elseif test="${activity.key.type == ActivityType.UPDATE}">
                                    <h3 class="timeline-header">${activity.candidate.getFullName()} have been updated</h3>
                                </g:elseif>
                                <g:else>
                                    <h3 class="timeline-header">${activity.candidate.getFullName()} have been deleted</h3>
                                </g:else>
                                ...
                                <div class="timeline-body">
                                    ...
                                    </span> by ${activity.consultant.getFullName()}
                                </div>
