            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="payroll.payrollCompany.id"
                    ...
                    <div class="form-group">
                        <label for="payroll.registrationNumber" class="col-md-4 control-label">
                    ...
                    <div class="form-group">
                        <label for="payroll.unqiueTaxReferenceNumber" class="col-md-4 control-label">
                            <g:message code="payroll.unique.tax.reference.number.label" default="Unique Tax Reference Nr."/>
                        </label>
                        <div class="col-sm-5">
                            <g:textField id="payrollUnqiueTaxReferenceNumber" name="payroll.unqiueTaxReferenceNumber" class="form-control" value="${candidateInstance?.payroll?.unqiueTaxReferenceNumber}" disabled="${!editable}" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="payroll.nationalInsuranceNumber" class="col-md-4 control-label">
                    ...
                    <div class="form-group">
                        <label for="payroll.registered" class="col-md-4 control-label">Registered</label>

                        <div class="col-md-5 " aria-checked="true" aria-disabled="true">

                            <g:if test="${editable}">
                                <g:radioGroup values="[true, false]" labels="['yes', 'no']" name="payroll.registered" value="${candidateInstance?.payroll?.registered}" >
                    ...
                    <div class="form-group">
                        <label for="payroll.inducted" class="col-md-4 control-label">Inducted</label>

                        <div class="col-md-5" aria-checked="true" aria-disabled="true">
                            <g:if test="${editable}">
                                <g:radioGroup values="[true, false]" labels="['yes', 'no']" name="payroll.inducted" value="${candidateInstance?.payroll?.inducted}" >
                                    <label class="control-label">
                                        ${it.radio}&nbsp;${it.label}
                                    </label>
                                    &nbsp;
